  ...
  return (
    <div className="footer-container">
      ...
      <div className="grid__column-4">
        ...
        <ul className="footer-list">
          <li className="footer-item">
            <Link to="/cart" className="footer-item__link">
              Giỏ hàng
            </Link>
          </li>
          <li className="footer-item">
            <Link to="/contact" className="footer-item__link">
              Liên hệ chúng tôi
            </Link>
          </li>
        </ul>
      ...
      <div className="grid__column-4">
        ...
        <ul className="footer-list">
          <li className="footer-item">
            <Link to="/sales" className="footer-item__link">
              Chính sách bán hàng
            </Link>
          </li>
          <li className="footer-item">
            <Link to="/guarantee" className="footer-item__link">
              Chính sách bảo hành
            </Link>
          </li>
          <li className="footer-item">
            <Link to="/transport" className="footer-item__link">
              Chính sách vận chuyển
            </Link>
          </li>
          <li className="footer-item">
            <Link to="/return_policy" className="footer-item__link">
              Chính sách đổi trả
            </Link>
          </li>
        </ul>
